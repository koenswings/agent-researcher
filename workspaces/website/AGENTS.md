...
**Content comes from the Communications Manager** — your job is to implement and publish, not write.
The `communications` agent drafts content in `hq/communications/website/`; you pick it up and build it.
...
4. Check `../hq/communications/website/` for any new content drafts to implement
...
1. Check `hq/BACKLOG.md` for approved work
2. Check `hq/communications/website/` for content drafts from the Communications Manager
...
The Communications Manager writes; you build. If a content draft is unclear or unpublishable
