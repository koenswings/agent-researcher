...
**Date:** pending (live CEO session required)
...
**In Mission Control (`https://openclaw-pi.tail2d60.ts.net:4000`):**

1. Log in — token at `/home/pi/openclaw/secrets/mc_local_auth_token.txt`
2. Settings → Gateways → Add Gateway:
   - URL: `wss://openclaw-pi.tail2d60.ts.net:443`
   - Workspace root: `/home/node/workspace`
   - Token: from `/home/pi/openclaw/secrets/openclaw_gateway_token.txt`
3. Create 5 boards:
   - Group **Engineering:** Engine Dev, Console Dev, Site Dev, Quality Manager
   - Group **HQ:** Programme Manager

**In OpenClaw (`https://openclaw-pi.tail2d60.ts.net`):**

4. Six agent tabs will be visible. For each of the 5 new agents
