...
- [ ] **Step 12:** Bring OpenClaw up briefly — verify all 6 agents visible — bring back down
- [ ] **Step 12a:** Deploy Mission Control — add MC service to `compose.yaml`; configure board hierarchy; bring back down
